    ...
    <section className="w-full  grid relative text-white grid-cols-9">
      <div ref={content} className="w-full opacity-0 gap-y-8 p-8 py-16 h-full relative flex flex-col col-span-5">
        ...
        <div className="w-full  gap-x-12 flex items-center">
          ...
          <button>
          <LinkS to="/about" className={`w-60 cursor-pointer uppercase hover:scale-95 transition-all duration-300 ease-out group flex items-center justify-center tracking-widest  h-16 border-2 border-orange  ${martel_sans.className}`}>
            Learn more
