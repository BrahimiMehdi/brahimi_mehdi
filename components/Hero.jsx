    ...
    <section name="/" className="w-full md:h-[80vh] snap-center  grid relative text-white grid-cols-1 grid-rows-2 md:grid-rows-1 md:grid-cols-9">
      <div ref={content} className="w-full opacity-0 gap-y-8 p-8 py-16 h-full relative flex flex-col col-span-5">
        ...
        <div className="w-full  gap-12 sm:flex-row flex-col flex items-center">
          <LinkS offset={-112} spy={true} smooth={true}  to="/about" className={` flex-grow cursor-pointer group max-w-xs flex  intersect font-medium w-full px-20 sm:w-72 items-center justify-around relative transition-all group duration-300 ease-out hover:bg-blue    uppercase tracking-widest  h-16 border-2 border-gray-100 bg-orange `}>
