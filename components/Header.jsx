    ...
    <header className="w-full grid   fixed top-0 z-50 bg-opacity-80 bg-dark-blue backdrop-blur intersect
     h-28 grid-cols-4 sm:grid-cols-6 md:grid-cols-9  text-white  ">
      ...
      <button className="w-full h-full relative ">
        ...
        <LinkS offset={-112} spy={true} smooth={true} activeClass="text-yellow"  data-info="6" to="/services" className="h-full transition-all  duration-300 ease-out hover:scale-90 text-sm tracking-widest opacity-0 w-full  font-semibold cursor-pointer innerInfo uppercase grid place-items-center">
            services
        </LinkS>
      </button>
      <button className="w-full h-full relative ">
